...
class LengthFormulasBody extends StatefulWidget {
  @override
  _LengthFormulasBodyState createState() =>
      _LengthFormulasBodyState();
}

class _LengthFormulasBodyState extends State<LengthFormulasBody> {
  var _fromUnits = [
    'Kilometer',
    'Meter',
    'Centimeter',
            ...
            if (_toCurrentSelectedItem == _toUnits.elementAt(1)) {
              _formulaWidget = RichText(
                text: TextSpan(children: [
                  TextSpan(
                      text: "Multiply the length value by ",
              ...
              _formulaWidget = RichText(
                text: TextSpan(children: [
                  TextSpan(
                      text: "For an approximate result, multiply the length value by ",
                      style: TextStyle(color: Colors.grey, fontSize: 18)),
                  TextSpan(
                      text: "1e+12",
                      style: TextStyle(
              ...
              _formulaWidget = RichText(
                text: TextSpan(children: [
                  TextSpan(
                      text: "For an approximate result, divide the length value by ",
                      style: TextStyle(color: Colors.grey, fontSize: 18)),
                  TextSpan(
                      text: "1.609",
                      style: TextStyle(
              ...
              _formulaWidget = RichText(
                text: TextSpan(children: [
                  TextSpan(
                      text: "Divide the length value by ",
                      style: TextStyle(color: Colors.grey, fontSize: 18)),
                  TextSpan(
                      text: "1.852",
                      style: TextStyle(
